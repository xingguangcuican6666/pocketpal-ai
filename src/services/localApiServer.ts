...
function normalizeMessages(
  ...
  // Some clients may accidentally send an object with numeric string keys (e.g., {"0": {...}, "1": {...}, foo: "bar"})
  // instead of a JSON array. Coerce any numeric-keyed entries into an array—sorted to preserve order—to prevent
  // downstream errors like "Object is an object, expected an array". Non-numeric keys are ignored.
